...
using MarketingBox.PasswordApi.Settings;
...
namespace MarketingBox.PasswordApi
{
    public class Program
    {
        ...
        {
            Console.Title = "MarketingBox.PasswordApi";

            Settings = SettingsReader.GetSettings<SettingsModel>(SettingsFileName);

            using var loggerFactory = LogConfigurator.ConfigureElk_v2("MarketingBox.PasswordApi", Settings.SeqServiceUrl, Settings.ElkLogs);
